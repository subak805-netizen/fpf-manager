...
// 로스 미설정이면 기본 로스 0%(TRIM_LOSS_PCT, 09-17o 전엔 2%): 벌당1 ×95=95 → 95개 → 9,500원.
TEST('문제 1. 로스 5% → 200개·20,000원 / 기본로스 0%', function(){
  ...
  CHECK('기본로스 0% 수량', r2.qty, 95);
  CHECK('기본로스 0% 금액', Math.round(r2.cost), 9500);
});
