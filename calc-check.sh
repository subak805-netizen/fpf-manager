...
FUNCS=['laborBase','hasLaborRule','_laborCtx','orderFc','snapshotOrderFc','calcFabAdditionForColor','calcFabShrinkForColor','_pbNegoFor','cmpDate','toISO','_poMatKey','_poMatQty','_poMatLabel','_poChangeDiff','_poMD','_poSetMatQty','_poCorrApplyTo','_poCorrLines','_poCorrFill','_poCorrCompose','_pbFindTrimMat','_pbTrimName','pbKey','pbDecodeKey','_fabE','_fabKwRules','_fabKwNorm','_fabKwHits','fabColorPrice','fabMaxPrice',
...
'_migrateFabBias','_poProcBlocks','_poFabProcNotes','_poTrimProcNotes','_pbCalcKey','_pbCalcApply','_pbCalcUnit','_pbSplitVal','_pbMinUnit','_tcQtyPerPiece','tcEffColors','_tcColorBasis','_tcFabOf','_tcFabYo','_migrateFabProcYo','_tcEffPcs','_tcTierIsFlat','trimCostPerPcs','calcFabExtraYdForColor','_fabAddTcs','_tcAll']
