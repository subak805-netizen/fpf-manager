...
FUNCS=['laborBase','hasLaborRule','_laborCtx','orderFc','snapshotOrderFc','calcFabAdditionForColor','calcFabShrinkForColor','_fabE','_fabKwRules','_fabKwNorm','_fabKwHits','fabColorPrice','fabMaxPrice',
