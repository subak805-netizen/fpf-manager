...
FUNCS=['laborBase','hasLaborRule','_laborCtx','orderFc','snapshotOrderFc','calcFabAdditionForColor','calcFabShrinkForColor','_pbNegoFor','cmpDate','_pbFindTrimMat','_pbTrimName','pbKey','pbDecodeKey','_fabE','_fabKwRules','_fabKwNorm','_fabKwHits','fabColorPrice','fabMaxPrice',
