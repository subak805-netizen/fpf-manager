...
FUNCS=['laborBase','hasLaborRule','_laborCtx','orderFc','snapshotOrderFc','calcFabAdditionForColor','calcFabShrinkForColor','_pbNegoFor','cmpDate','toISO','_poMatKey','_ruLbl','_ruU','_poMatQty','_poMatLabel','_poChangeDiff','_poMD','_poSetMatQty','_poCorrApplyTo','_poCorrLines','_poCorrFill','_poCorrCompose','_pbFindTrimMat','_pbTrimName','pbKey','pbDecodeKey','_fabE','_fabKwRules','_fabKwNorm','_fabKwHits','fabColorPrice','fabMaxPrice',
...
'getPayFees','payFeeAmt','payFeeBlock','bgUnitPrice','sewLaborBase','laborRate','hasLaborBySize','_lvPending','_repairing','_shipExcl','_smMine','_bgDcOf','_smRespIsFc','_smNetDelta','shipMoves','smMoveTag','shipBoard','shipEffRecs',
...
CONSTS=['COST_DEFS','PB_CALC_MODES','_PB_CALC_LEGACY','_PB_CALC_FIXED','SM_BK']
